...
A comprehensive, world-class transport management solution with AI-powered features
Developed with excellence for Daffodil International University
...
# ==================== CUSTOM CSS - WORLD-CLASS GLASSMORPHISM DESIGN ====================
def inject_custom_css():
    ...
    <style>
        ...
        * {
        ...
        .stApp {
            background: linear-gradient(135deg, #0a1628 0%, #1a2f45 25%, #0f1f33 50%, #1a2f45 75%, #0a1628 100%);
